    ...
    <div className="proy" id="proy">
      ...
      <div className="cont-proy">
        ...
        <div className="proy-tarjetas">
            ...
            <TarjetaProy fecha="OCT 23 - OCT 25 2023" titulo="Simple-Calc" descripcion="Calculadora que permite realizar operaciones basicas ademas de mostrar operaciones que ya se realizaron anteriormente." ruta="images/appcalc.jpg" tec1="html5" id1="html5" tec2="css3" id2="css3" tec3="javascript" id3="javascript"/>
            </a>
            <a href="https://solodeveloperalpha.github.io/LocalWeather/" target="_blank">
              <TarjetaProy fecha="OCT 16 - OCT 25 2023" titulo="LocalWeather" descripcion="Obtén acceso instantáneo a la temperatura actual, pronósticos a corto y largo plazo, velocidad del viento, humedad y más, todo presentado en una interfaz fácil de usar." ruta="images/appclima.jpg" tec1="html5" id1="html5" tec2="css3" id2="css3" tec3="javascript" id3="javascript"/>
            </a>
            ...
            <TarjetaProy fecha="MAR 18 2023" titulo="Edie-Homepage-master PORTFOLIO" descripcion="Un ejemplo de Portfolio realizado como Reto o Challenge por la pagina de DevChallenges.io" ruta="images/appEdieExamplePortfolio.jpg" tec1="html5" id1="html5" tec2="css3" id2="css3" tec3="javascript" id3="javascript"/>
            </a>
